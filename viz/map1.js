#2e2e36// self-calling anonymous function for private scope
(function () { // write everything inside the bracket of this function
    ...
    var color = d3.scaleThreshold()
        ...
        .range(["#E7572E", "#F67E5C", "#FFBBA8", "#C6E8F6", "#7AD0EF", "#2EB4E7"]);
   ...
   //set up interactive functionality for tooltip
    ...
    if (div_width<500){
    var  legend_data = [[div_width/2, 15,"#E7572E","null","1","1"],[div_width/2, 37,"#F67E5C","0,25","2","2"],[div_width/2, 49,"#FFBBA8","25,50","3","3"], [div_width/2, 61,"#C6E8F6","50,75","4","4"],
    [div_width/2, 73,"#7AD0EF","75,99.99","5","5"],[div_width/2, 95,"#2EB4E7","99.99,100","7","7"],[div_width/2 , 110,"#64646A","missing","8","8"]];
    ...
    [div_width/2+50, 13,"#7AD0EF","75,99.99","5","6"],[div_width/2+150, 13,"#2EB4E7","99.99,100","7","7"],[div_width/2 -25, 68,"#64646A","missing","8","8"]];
